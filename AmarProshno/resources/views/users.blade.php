                ...
                <div class="Allque">
                    ...
                    <div class="DiscriptionBox">
                        <p class="QuetionDis">
                            ...
                            <a href="{{ url('/Read-More/'.$data->id) }}" class="btn btn-primary btn-xs">read more...</a> <i class="fa-windows-close"></i>
                        </p>
                        <p class="Quetag">
                            ...
                            @if(isset($data->html) == $data->html )
                                <span class="tag">{{ $data->html }}
                                    @if( Auth::user()->id == $data->user_id)
                                        <a href="{{ url('/DeleteHtml/'.$data->id) }}" style="color:#e16b85;"><i class="fa fa-times"></i></a>
                                    @endif
                                </span>
                            @endif
                            @if(isset($data->css) == $data->css)
                                <span class="tag">{{ $data->css }}
                                    @if( Auth::user()->id == $data->user_id )
                                        <a href="{{ url('/DeleteCss/'.$data->id) }}" style="color:#e16b85;"><i class="fa fa-times"></i></a>
                                    @endif
                                </span>
                            @endif
                            @if(isset($data->php) == $data->php)
                                <span class="tag">{{ $data->php }}
                                    @if( Auth::user()->id == $data->user_id)
                                        <a href="{{ url('/DeletePhp/'.$data->id) }}" style="color:#e16b85;"><i class="fa fa-times"></i></a>
                                    @endif
                                </span>
                            @endif
                            @if(isset($data->oop) == $data->oop)
                                <span class="tag">{{ $data->oop }}
                                    @if( Auth::user()->id == $data->user_id)
                                        <a href="{{ url('/DeleteOop/'.$data->id) }}" style="color:#e16b85;"><i class="fa fa-times"></i></a>
                                    @endif
                                </span>
                            @endif
                            @if(isset($data->mysql) == $data->mysql)
                                <span class="tag">{{ $data->mysql }}
                                    @if( Auth::user()->id == $data->user_id)
                                        <a href="{{ url('/DeleteMysql/'.$data->id) }}" style="color:#e16b85;"><i class="fa fa-times"></i></a>
                                    @endif
                                </span>
                            @endif
                            @if(isset($data->javascript) == $data->javascript)
                                <span class="tag">{{ $data->javascript }}
                                    @if( Auth::user()->id == $data->user_id)
                                        <a href="{{ url('/DeleteJavascript/'.$data->id) }}" style="color:#e16b85;"><i class="fa fa-times"></i></a>
                                    @endif
                                </span>
                            @endif
                            @if(isset($data->ajax) == $data->ajax)
                                <span class="tag">{{ $data->ajax }}
                                    @if( Auth::user()->id == $data->user_id)
                                        <a href="{{ url('/DeleteAjax/'.$data->id) }}" style="color:#e16b85;"><i class="fa fa-times"></i></a>
                                    @endif
                                </span>
                            @endif
                            @if(isset($data->jquery) == $data->jquery)
                                <span class="tag">{{ $data->jquery }}
                                    @if( Auth::user()->id == $data->user_id)
                                        <a href="{{ url('/DeleteJquery/'.$data->id) }}" style="color:#e16b85;"><i class="fa fa-times"></i></a>
                                    @endif
                                </span>
                            @endif
                        </p>
